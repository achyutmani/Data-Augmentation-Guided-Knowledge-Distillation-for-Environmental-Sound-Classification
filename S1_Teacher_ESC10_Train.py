...
#print(weight)
weight=np.array([0.35,0.015,0.08,0.8,0.014,0.011,0.8,0.019,0.35,0.35])
...
def evaluate(model,device,iterator, criterion): # Evaluate Validation accuracy 
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator) 
MODEL_SAVE_PATH = os.path.join("/home/mani/Desktop/AK/TASLP 2021/FB Model Training/TASLP_FInal_KD", 'S1_Teacher_ESC10_CNN.pt') # Define Path to save the model 
...
np.save('S1_Teacher_ESC10_CNN_Parameters',Temp) # Save Temp Array as numpy array 
