...
test_loss, test_acc = evaluate(Student_Model, device, test_loader, criterion)
...
with torch.no_grad():
    ...
    test_preds,test_actual = get_all_preds(Student_Model,test_loader)
...
plt.tight_layout()
plt.savefig('Student_ESC10_CM.png')
plt.show()  
